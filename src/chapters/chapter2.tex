...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=\linewidth]{src/assets/images/Compnaies use case.drawio.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=\linewidth]{src/assets/images/HRMGlobalUseCase.drawio.png}}
    \caption{ Global System Use-Case Diagram }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=0.9\linewidth]{src/assets/logos/dartLogo.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=0.6\linewidth]{src/assets/logos/openAILogo.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=\linewidth]{src/assets/images/ICD-Application-Global-Architecture-Final-Edition.jpg}}
